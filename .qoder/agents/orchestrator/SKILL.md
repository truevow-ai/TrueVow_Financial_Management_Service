...
## References
- **Rules:** `.qoder/rules/qoder-rules.md`
- **Domain:** `.qoder/skills/fintech-patterns.md`
...
|-------|------------|---------|
| search-agent | `.qoder/agents/search-agent/SKILL.md` | Find code, trace dependencies, locate patterns |
| code-agent | `.qoder/agents/code-agent/SKILL.md` | Write/modify code, follow repo patterns |

### Application Agents (Financial Modules)
| Agent | Skill File | Purpose |
|-------|------------|---------|
| gl-agent | `.qoder/agents/gl-agent/SKILL.md` | General Ledger, journal entries, chart of accounts |
| ar-agent | `.qoder/agents/ar-agent/SKILL.md` | Accounts Receivable, invoices, payments, deferred revenue |
| ap-agent | `.qoder/agents/ap-agent/SKILL.md` | Accounts Payable, vendor bills, AP workflows |
| payroll-agent | `.qoder/agents/payroll-agent/SKILL.md` | Payroll runs, approvals, payment batches |
| treasury-agent | `.qoder/agents/treasury-agent/SKILL.md` | Bank accounts, transactions, FX, settlements |
| intercompany-agent | `.qoder/agents/intercompany-agent/SKILL.md` | Intercompany transfers, royalties, reconciliation |
| reporting-agent | `.qoder/agents/reporting-agent/SKILL.md` | Financial statements, trial balance, aging, cash flow |
| affiliates-agent | `.qoder/agents/affiliates-agent/SKILL.md` | Affiliate management |
| benjamin-agent | `.qoder/agents/benjamin-agent/SKILL.md` | Benjamin INTAKE voice AI — vendor cost tracking, OpEx budgeting |
